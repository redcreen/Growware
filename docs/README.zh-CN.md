...
| 理解稳定系统边界 | [architecture.zh-CN.md](architecture.zh-CN.md) |
...
| 检查当前文档基线如何验证 | [test-plan.zh-CN.md](test-plan.zh-CN.md) |
...
- Growware 参考资料包：[reference/growware/README.zh-CN.md](reference/growware/README.zh-CN.md)
