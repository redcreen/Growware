...
| [Stage 1 - Project 1 Pilot Foundation Long Task](reference/growware/development-plan.md#stage-1-objectives) | planned / not started | define Project 1, OpenClaw bindings, daemon boundaries, contracts, and start conditions in one long task | Stage 2 implementation gate | target, channel binding, feedback/incident/judge/verifier/deploy contracts, and daemon interfaces are explicit |
...
- the A/B channel and daemon discussion is already happening around it
