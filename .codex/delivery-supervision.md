...
- Direction: `Stage 1 long task planned; waiting for user start command.`
- Status: `active`
- Why Now: keep the Stage 1 long task fully specified for `Project 1`, including OpenClaw bindings, daemon boundaries, and the first operational contracts, while holding execution until the user explicitly starts it
